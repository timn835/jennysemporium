...
const ReceiptEmail = ({
  ...
  const total =
    products.reduce((total, product) => total + product.price, 0) + 1; // add one for the transaction fee
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Text style={footerCopyright}>
            Copyright ©{new Date().getFullYear()} Jenny&apos;s Treasure
            Emporium. <br /> <Link href="#">All rights reserved</Link>
          </Text>
        </Container>
      </Body>
    </Html>
