...
exports.Media = {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            // people browsing the store should view images
                            // either not logged in, or not on a /sell path
    ...
    upload: {
        ...
        mimeTypes: ["image/*"], //specifies that media must be any type of image (jpg, png, etc)
    },
    fields: [
        {
            name: "user",
